...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserSkillLevel::class, mappedBy: 'user', orphanRemoval: true, cascade: ['remove'])]
    ...
    public function removeUserSkillLevel(UserSkillLevel $userSkillLevel): static
    {
        if ($this->userSkillLevels->removeElement($userSkillLevel)) {
            ...
            if ($userSkillLevel->getUser() === $this) {
                $userSkillLevel->setUser(null);
            }
        }
